...
root.resizable(0,0)
myDB = mysql.connector.connect(host = "localhost", username = "root", password = "mysequel",database = "project")
Bg = ImageTk.PhotoImage(Image.open("./Space9.jpg").resize((1201,800)))
View = ImageTk.PhotoImage(Image.open("./View.png").resize((110,110)))
Edit = ImageTk.PhotoImage(Image.open("./Edit2.png").resize((110,103)))
Scenario = ImageTk.PhotoImage(Image.open("./Scenario.png").resize((110,110)))
Credits = ImageTk.PhotoImage(Image.open("./Credits.png").resize((127,110)))
Home()
root.mainloop()