...
CREATE TABLE `temperatures` (
  ...
  `deg_celsius` varchar(20) NOT NULL,
  PRIMARY KEY (`t_id`)
...
INSERT INTO `temperatures` VALUES (1,'Room Temperature','24'),(2,'Cool','18'),(3,'Warm','28'),(4,'Cold','10'),(5,'Hot','32'),(6,'Very Cold','0'),(7,'Very Hot','40');
